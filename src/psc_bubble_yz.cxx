...
struct PscBubble : Psc<PscConfig>, PscBubbleParams
{
  ...
  void init_npt(int kind, double crd[3], psc_particle_npt& npt) // It looks that this is changing the initial distribution of particles Jeff 010520
  {
  ...
  {
// //This entire part is not called in the whistler file. In addition it seems this is just for electrons
//---------------------------------------------------------------------------------------------------------------
#if 0
    n_prts_by_patch[0] = 2;
